...
from crud.user_crud import get_current_active_user,  get_current_user, get_user_by_username, create_user, get_user, get_users
...
def create_user(user: UserCreate, db: Session = Depends(deps.get_db), token = Depends(get_current_user)): #auth_crud.get_auth_token
